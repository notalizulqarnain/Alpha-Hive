      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl rounded-3xl bg-[#111111] border border-white/10 shadow-2xl p-5 sm:p-8 md:p-10 z-10 max-h-[90vh] overflow-y-auto text-white"
          >
            {/* Top Close Button */}
            <button
              onClick={resetModal}
              className="absolute top-4 right-4 sm:top-6 sm:right-6 p-2 rounded-full bg-white/5 text-slate-400 hover:text-white hover:bg-white/10 transition-colors cursor-pointer border border-white/10"
            ...
            <div className="mb-6 sm:mb-8 pr-8">
              <div className="flex items-center gap-2 text-[#3eb5e5] text-[10px] sm:text-xs font-semibold uppercase tracking-wider sm:tracking-[0.18em] mb-1.5 sm:mb-2">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  <button
                    ...
                    className={`p-4 sm:p-6 rounded-2xl border text-left transition-all duration-300 cursor-pointer ${
                  ...
                  >
                    <TrendingUp className="w-5 h-5 sm:w-6 sm:h-6 text-[#3eb5e5] mb-2 sm:mb-3" />
                    <h4 className="font-sans font-bold text-sm sm:text-base text-white">
                      Accumulating Wealth
                    </h4>
                    <p className="text-[11px] sm:text-xs mt-1.5 sm:mt-2 leading-relaxed font-normal text-slate-400">
                  ...
                  >
                    <Landmark className="w-5 h-5 sm:w-6 sm:h-6 text-[#3eb5e5] mb-2 sm:mb-3" />
                    <h4 className="font-sans font-bold text-sm sm:text-base text-white">
                      Accumulated Wealth
                    </h4>
                    <p className="text-[11px] sm:text-xs mt-1.5 sm:mt-2 leading-relaxed font-normal text-slate-400">
              ...
              <div className="space-y-4 sm:space-y-6">
                  ...
                  {focusOptions.map((opt) => {
                    ...
                    return (
                      <button
                        ...
                        className={`p-3 sm:p-3.5 rounded-2xl border text-left text-xs font-semibold flex items-center justify-between transition-all duration-200 cursor-pointer ${
                          isChecked
                      ...
                      >
                        ...
                        <div
                          className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full flex items-center justify-center border text-[10px] shrink-0 ml-2 ${
                            isChecked
                ...
                <div className="flex items-center justify-between pt-4 border-t border-white/10">
                  <button
                    type="button"
                    onClick={() => setStep(1)}
                    className="text-xs font-semibold uppercase tracking-wider text-slate-400 hover:text-white cursor-pointer px-2 py-1"
                  >
                    Back
                  </button>
                  <button
                    ...
                    className="px-5 sm:px-6 py-2.5 sm:py-3 rounded-full bg-[#3eb5e5] hover:bg-[#3eb5e5]/90 text-[#082133] text-xs font-bold uppercase tracking-wider transition-all disabled:opacity-40 disabled:cursor-not-allowed flex items-center gap-2 shadow-lg shadow-[#3eb5e5]/20 cursor-pointer"
                  >
