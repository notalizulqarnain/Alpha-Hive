    ...
    <section id="contact" className="py-20 sm:py-28 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          >
            <div className="rounded-3xl p-8 bg-[#111111] border border-white/10 space-y-6">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-2xl bg-[#3eb5e5]/10 border border-[#3eb5e5]/30 text-[#3eb5e5] flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-lg sm:text-xl font-sans font-bold text-white hover:text-[#3eb5e5] transition-colors block mt-0.5"
                  >
                    +44 20 7390 0837
                  </a>
                </div>
              ...
              <div className="flex items-start gap-4 pt-4 border-t border-white/10">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 font-normal">9:00am - 5:00pm</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 pt-4 border-t border-white/10">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 font-normal">London, SW3 1JJ</p>
                </div>
              </div>
            </div>

            <div className="rounded-3xl overflow-hidden border border-white/10 shadow-card relative h-64 bg-slate-900">
              <iframe
              ...
              />
              <div className="absolute bottom-3 left-3 bg-[#0a0a0a]/90 px-3.5 py-1.5 rounded-full border border-white/10 text-xs font-semibold text-white flex items-center gap-1.5 backdrop-blur-sm shadow-subtle">
          ...
          >
            <div className="rounded-3xl p-8 sm:p-12 bg-[#111111] border border-white/10 shadow-card relative">
              {!isSubmitted ? (
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-5 py-3.5 rounded-2xl border border-white/10 focus:border-[#3eb5e5] focus:ring-1 focus:ring-[#3eb5e5] outline-none text-sm bg-white/5 text-white placeholder:text-slate-500 focus:bg-white/[0.08] transition-all"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-5 py-3.5 rounded-2xl border border-white/10 focus:border-[#3eb5e5] focus:ring-1 focus:ring-[#3eb5e5] outline-none text-sm bg-white/5 text-white placeholder:text-slate-500 focus:bg-white/[0.08] transition-all resize-none"
                    />
                  </div>

                  <button
                    type="submit"
                    className="w-full py-4 rounded-full bg-[#3eb5e5] hover:bg-[#3eb5e5]/90 text-[#082133] font-semibold text-sm shadow-lg shadow-[#3eb5e5]/20 hover:shadow-[#3eb5e5]/30 transition-all duration-300 flex items-center justify-center gap-2 group cursor-pointer"
                  >
                    <span>Submit</span>
                ...
                <div className="text-center py-12 space-y-4">
                  <div className="w-14 h-14 bg-[#3eb5e5]/10 text-[#3eb5e5] border border-[#3eb5e5]/30 rounded-full flex items-center justify-center mx-auto shadow-subtle">
