      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-white/5 hover:bg-white/10 text-white border border-white/10 text-xs font-semibold uppercase tracking-wider transition-all shadow-subtle hover:shadow-card cursor-pointer"
          >
              ...
              <div className="relative h-80 overflow-hidden bg-slate-900">
                ...
                {member.accolades && (
                  <div className="absolute top-4 left-4 right-4">
                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-gold-400 text-black text-[10px] font-semibold uppercase tracking-[0.12em] shadow-subtle group-hover:bg-gold-400 transition-colors">
                ...
                <div className="absolute bottom-4 left-4 right-4 text-white">
                  <h3 className="font-sans font-bold text-2xl text-white group-hover:text-gold-400 transition-colors">
                    {member.name}
                  </h3>
