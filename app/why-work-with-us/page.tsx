      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24 sm:space-y-32">
        ...
        <section>
            ...
            {values.map((val, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="p-8 rounded-3xl bg-white/[0.03] border border-white/10 hover:border-[#3eb5e5]/40 hover:-translate-y-1 transition-all duration-300 space-y-4 group"
                >
                  <div className="w-12 h-12 rounded-2xl bg-[#3eb5e5]/10 border border-[#3eb5e5]/30 text-[#3eb5e5] flex items-center justify-center group-hover:scale-110 transition-transform">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="p-8 sm:p-10 rounded-3xl bg-white/[0.02] border border-white/10 text-center max-w-4xl mx-auto backdrop-blur-sm"
          >
            <p className="text-base sm:text-lg text-slate-300 font-normal leading-relaxed italic">
        ...
        <section className="rounded-3xl bg-white/[0.03] border border-white/10 p-8 sm:p-12 lg:p-16 overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              <div className="relative w-64 h-80 rounded-3xl overflow-hidden border border-white/10 bg-slate-900">
                <img
              ...
              <div>
                <h3 className="font-sans font-bold text-2xl text-white">Kanishk Swarup</h3>
                <p className="text-xs text-slate-400 font-semibold uppercase tracking-[0.15em] mt-0.5">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#3eb5e5]/10 text-[#3eb5e5] text-xs font-semibold uppercase tracking-[0.15em] border border-[#3eb5e5]/30">
              ...
              >
                <div className="relative h-80 overflow-hidden bg-slate-900">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 text-white">
                    <h3 className="font-sans font-bold text-2xl text-white group-hover:text-[#3eb5e5] transition-colors">
                      {member.name}
                    </h3>
                ...
                <div className="p-6 flex flex-col justify-between flex-grow space-y-4 bg-[#111111]">
                  ...
                  <Link
                    ...
                    className="w-full py-3 rounded-full bg-white/5 hover:bg-[#3eb5e5]/10 text-white hover:text-[#3eb5e5] text-xs font-semibold uppercase tracking-wider text-center transition-all duration-300 block border border-white/10 hover:border-[#3eb5e5]/40 cursor-pointer"
                  >
                    View Profile
                  </Link>
                </div>
